        ...
        <div class="container">
          ...
          <nav class="collapse navbar-collapse menu">
            <ul class="nav navbar-nav sf-menu">
              ...
              <li>
                <a href="about.jsp" id="current">关于我们</a>
              </li>
            </ul>
          </nav>
          <!-- Menu End -->
     ...
     <div class="content">
        <div class="container">
              ...
              <div class="posts-block col-lg-12 col-md-12 col-sm-12 col-xs-12">
                 <article>
                    ...
                    <div class="post-content">
                       ...
                       <br>
                       <p>   本站不定期发布各种虚拟货币糖果信息，让你各种虚拟货币糖果领到手软:) </p>
                       <br>
                       <p>   我们是追求品质与力求不断超越自己的团队，每一位成员也是亲密的伙伴，与公司一起成长与发展。我们尊重每次合作的机会与挑战，不断精进，力求完美。 </p>
                    </div>
                 </article>
              </div>
              <!-- Left Section End -->
           ...
           <div class="row">
              <div class="posts-block col-lg-12 col-md-12 col-sm-12 col-xs-12">
                 <article>
                    ...
                    <div class="post-content">
                       <p>   我们的生存，就是在恶劣的环境中坚强地创造生存空间；我们的团队，就是在充满争斗的对手中组织强大的团队；力量；我们的智慧，就是在强着之列不断竞争、超越！</p>
                       <br>
                    </div>
                 </article>
              </div>
           ...
           <div class="row">
              <div class="posts-block col-lg-12 col-md-12 col-sm-12 col-xs-12">
                 <article>
                    <h3 class="title">我们的愿景</h3>
                    <div class="post-content">
                       <p>   发布各种虚拟货币糖果信息，让你各种虚拟货币糖果领到手软:)</p>
                       <br>
                    </div>
                 </article>
              </div>
