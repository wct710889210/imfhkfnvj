        ...
        <div class="row">
          <div class="posts-block col-lg-10 col-md-8 col-sm-8 col-xs-12 col-lg-offset-1">
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <button type="button" class="btn-color btn-small btn-pad invite text-center" data-container="body"
                        data-toggle="popover" data-placement="bottom" data-content="已复制" id="copy">复制
                </button>
              </div>
            </div>
