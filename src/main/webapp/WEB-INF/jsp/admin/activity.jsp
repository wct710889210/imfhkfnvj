            ...
            <div class="sidebar-content">
              ...
              <ul class="sidebar-nav">
                ...
                <li class="active">
                  ...
                  <ul>
                    <li>
                      <a href="activity.html" class="active">活动发布</a>
                    </li>
                    <li>
        ...
        <div id="main-container">
          ...
          <div id="page-content">
            ...
            <div class="block full">
              ...
              <!-- Get Started Content -->
              <form action="activityUpload" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <textarea id="example-textarea-input" name="content" rows="7" class="form-control" placeholder=""></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-3 control-label" for="example-text-input">领取方法</label>
                  <div class="col-md-6">
                    <textarea id="example-textarea-input" name="method" rows="3" class="form-control" placeholder=""></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-3 control-label" for="example-text-input">领取地址</label>
                  <div class="col-md-6">
                    <input type="text" id="example-text-input" name="address" class="form-control" required="required">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-2">
                    <input type="text" id="example-text-input" name="price" class="form-control" required="required">
                  </div>
                </div>
                <div class="form-group">
