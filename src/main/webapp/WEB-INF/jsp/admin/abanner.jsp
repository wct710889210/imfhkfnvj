              ...
              <ul class="sidebar-nav">
                <li class="active">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="abanner.html" class="active">轮播图管理</a>
                    </li>
                  </ul>
                </li>
                <li>
                ...
                <table id="example-datatable" class="table table-striped table-bordered table-vcenter">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center" style="width: 750px;">介绍</th>
                  ...
                  <tbody>
                    <c:forEach var="banner" items="${banners}">
                      <tr>
                        ...
                        <td class="text-center">
                          <a href="bannerChange/${banner.getId()}" data-toggle="tooltip" title="修改" class="btn btn-effect-ripple btn-xs btn-success">
                            <i class="fa fa-pencil"></i>
                          </a>
                          <a onclick="return del()" href="bannerDelete/${banner.getId()}" data-toggle="tooltip" title="删除" class="btn btn-effect-ripple btn-xs btn-danger">
