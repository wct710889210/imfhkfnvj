              ...
              <ul class="sidebar-nav">
                ...
                <li class="active">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="aclass.html" class="active">文章管理</a>
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <tbody>
                    <volist name="result" id="vo">
                      <tr>
                        ...
                        <td class="text-center">
                          糖果系列四：比特糖果——数字货币的免费午餐
                        </td>
                        <td class="text-center">
                          2018-03-05 19:14:22
                        </td>
                        <td class="text-center">
                          <a href="mclass.html" data-toggle="tooltip" title="修改" class="btn btn-effect-ripple btn-xs btn-success">
                            <i class="fa fa-pencil">
                            </i>
                          </a>
                          <a onclick="return del()" href="{$Think.config.GOTO}Admin/Notice/delete?id={$vo.id}" data-toggle="tooltip" title="删除" class="btn btn-effect-ripple btn-xs btn-danger">
                            <i class="fa fa-times">
                            </i>
                          </a>
                        </td>
