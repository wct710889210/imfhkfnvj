            ...
            <div class="block full">
              ...
              <form action="/classModify/${bitclass.getId()}" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input type="text" id="example-text-input" name="title" class="form-control" required="required" value="${bitclass.getTitle()}" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-3 control-label" for="example-text-input">发布人</label>
                  <div class="col-md-6">
                    <input type="text" id="example-text-input" name="auth" class="form-control" required="required" value="${bitclass.getAuth()}"/>
                  </div>
                </div>
                <div class="form-group">
